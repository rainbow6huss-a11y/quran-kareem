...
export default function KhatmaPage({ toggleDark, dark, showToast }) {
  ...
  function changePlan(days) {
    setPlan(days);
    localStorage.setItem('q_plan', days);
  }
    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.hero}>
          ...
          <p className={styles.sub}>تابع رحلتك مع كتاب الله</p>
